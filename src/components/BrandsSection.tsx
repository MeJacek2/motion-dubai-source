const brands = [
  { name: "NACHI", origin: "Japan", color: "bg-primary" },
  { name: "KOYO", origin: "Japan", color: "bg-primary" },
  { name: "NTN", origin: "Japan", color: "bg-primary" },
  { name: "THK", origin: "Japan", color: "bg-primary" },
  { name: "NFC", origin: "China", color: "bg-accent" },
];
